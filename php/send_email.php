<?php
//send_email.php
$email_from = "nomail@person.at";   //Absender falls keiner angegeben wurde
$sendermail_antwort = true;      //E-Mail Adresse des Besuchers als Absender. false= Nein ; true = Ja
$name_von_emailfeld = "Email";   //Feld in der die Absenderadresse steht
 
$empfaenger = "office@st-beschichtungstechnik.at"; //Empfänger-Adresse
$mail_cc = ""; //CC-Adresse, diese E-Mail-Adresse bekommt einer weitere Kopie
$betreff = "Neue Kontaktanfrage"; //Betreff der Email
 
$url_ok = "http://www.st-beschichtungstechnik.at/ok.html"; //Zielseite, wenn E-Mail erfolgreich versendet wurde
$url_fehler = "http://www.st-beschichtungstechnik.at/fehler.html"; //Zielseite, wenn E-Mail nicht gesendet werden konnte
